...
import 'package:video_window_server/src/generated/capabilities/capability_status_response.dart'
    as _i4;
...
import 'package:video_window_server/src/generated/capabilities/trusted_device.dart'
    as _i8;
import 'package:video_window_server/src/generated/profile/user_profile.dart'
    as _i9;
...
import 'package:video_window_server/src/generated/profile/notification_preferences.dart'
    as _i11;
import 'package:video_window_server/src/generated/greeting.dart' as _i12;
...
class TestEndpoints {
  late final _CapabilityEndpoint capability;

  late final _DeviceEndpoint device;

  late final _FeedEndpoint feed;

  late final _InteractionEndpoint interaction;
  ...
  late final _StripeWebhookEndpoint stripeWebhook;
...
class _InternalTestEndpoints extends TestEndpoints
  ...
  void initialize(
    ...
    capability = _CapabilityEndpoint(
      endpoints,
    ...
    interaction = _InteractionEndpoint(
      endpoints,
      serializationManager,
    );
    ...
    story = _StoryEndpoint(
      endpoints,
      serializationManager,
    );
    stripeWebhook = _StripeWebhookEndpoint(
      endpoints,
      serializationManager,
    );
...
class _CapabilityEndpoint {
  ...
  _i3.Future<_i4.CapabilityStatusResponse> getStatus(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        ) as _i3.Future<_i4.CapabilityStatusResponse>);
  ...
  _i3.Future<_i4.CapabilityStatusResponse> requestCapability(
    _i1.TestSessionBuilder sessionBuilder,
    int userId,
    _i5.CapabilityRequestDto request,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
  ...
  _i3.Future<List<_i6.CapabilityRequest>> getRequests(
    _i1.TestSessionBuilder sessionBuilder,
    int userId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<Map<String, dynamic>> getStripeOnboardingLink(
    _i1.TestSessionBuilder sessionBuilder,
    int userId,
    String returnUrl,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'capability',
        method: 'getStripeOnboardingLink',
      );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
...
class _DeviceEndpoint {
  ...
  _i3.Future<_i8.TrustedDevice> registerDevice(
    _i1.TestSessionBuilder sessionBuilder,
    int userId,
    String deviceId,
    String deviceType,
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue = await (_localCallContext.method.call(
          _localUniqueSession,
          _localCallContext.arguments,
        ) as _i3.Future<_i8.TrustedDevice>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<List<_i8.TrustedDevice>> getDevices(
    _i1.TestSessionBuilder sessionBuilder,
    int userId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue = await (_localCallContext.method.call(
          _localUniqueSession,
          _localCallContext.arguments,
        ) as _i3.Future<List<_i8.TrustedDevice>>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
...
class _FeedEndpoint {
  ...
  _i3.Future<Map<String, dynamic>> getFeedVideos(
    _i1.TestSessionBuilder sessionBuilder, {
    String? userId,
  ...
  _i3.Future<Map<String, dynamic>> recordInteraction(
    _i1.TestSessionBuilder sessionBuilder, {
...
class _InteractionEndpoint {
  _InteractionEndpoint(
    this._endpointDispatch,
    this._serializationManager,
  );
...
class _AuthEndpoint {
  ...
  _i3.Future<Map<String, dynamic>> sendOtp(
    _i1.TestSessionBuilder sessionBuilder,
    String email,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<Map<String, dynamic>> verifyAppleToken(
    _i1.TestSessionBuilder sessionBuilder,
    String idToken, {
    String? deviceId,
  }) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'auth',
        method: 'verifyAppleToken',
      );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'auth',
          methodName: 'verifyAppleToken',
          parameters: _i1.testObjectToJson({
            'idToken': idToken,
            'deviceId': deviceId,
          }),
  ...
  _i3.Future<Map<String, dynamic>> verifyGoogleToken(
    _i1.TestSessionBuilder sessionBuilder,
    String idToken, {
    String? deviceId,
  }) async {
  ...
  _i3.Future<Map<String, dynamic>> sendRecovery(
    _i1.TestSessionBuilder sessionBuilder,
    String email, {
    String? deviceInfo,
    String? userAgent,
  ...
  _i3.Future<Map<String, dynamic>> verifyRecovery(
    _i1.TestSessionBuilder sessionBuilder,
    String email,
    String token, {
    String? deviceId,
  ...
  _i3.Future<Map<String, dynamic>> revokeRecovery(
    _i1.TestSessionBuilder sessionBuilder,
    String email,
    String token,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'auth',
        method: 'revokeRecovery',
      );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'auth',
          methodName: 'revokeRecovery',
          parameters: _i1.testObjectToJson({
            'email': email,
            'token': token,
          }),
...
class _MetricsEndpoint {
  ...
  _i3.Future<String> getMetrics(_i1.TestSessionBuilder sessionBuilder) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'metrics',
...
class _OfferEndpoint {
  ...
  _i3.Future<Map<String, dynamic>> submitOffer(
    _i1.TestSessionBuilder sessionBuilder,
    int storyId,
    double amount,
  ) async {
...
class _OrderEndpoint {
  ...
  _i3.Future<Map<String, dynamic>?> getOrder(
    _i1.TestSessionBuilder sessionBuilder,
    int orderId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<Map<String, dynamic>> updateShipping(
    _i1.TestSessionBuilder sessionBuilder,
    int orderId,
...
class _ProfileEndpoint {
  ...
  _i3.Future<_i9.UserProfile?> getMyProfile(
    _i1.TestSessionBuilder sessionBuilder,
    int userId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<_i9.UserProfile> updateMyProfile(
    _i1.TestSessionBuilder sessionBuilder,
    int userId,
  ...
  _i3.Future<_i10.PrivacySettings> getPrivacySettings(
    _i1.TestSessionBuilder sessionBuilder,
    int userId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue = await (_localCallContext.method.call(
          _localUniqueSession,
          _localCallContext.arguments,
        ) as _i3.Future<_i10.PrivacySettings>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<_i10.PrivacySettings> updatePrivacySettings(
    _i1.TestSessionBuilder sessionBuilder,
    int userId,
  ...
  _i3.Future<_i11.NotificationPreferences> getNotificationPreferences(
    _i1.TestSessionBuilder sessionBuilder,
    int userId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        ...
        var _localReturnValue = await (_localCallContext.method.call(
          _localUniqueSession,
          _localCallContext.arguments,
        ) as _i3.Future<_i11.NotificationPreferences>);
        return _localReturnValue;
      } finally {
        await _localUniqueSession.close();
      }
  ...
  _i3.Future<_i11.NotificationPreferences> updateNotificationPreferences(
    _i1.TestSessionBuilder sessionBuilder,
    int userId,
  ...
  _i3.Future<Map<String, dynamic>> requestDSARExport(
    _i1.TestSessionBuilder sessionBuilder,
    int userId, {
    String? otpCode,
  }) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'profile',
        method: 'requestDSARExport',
      );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'profile',
          methodName: 'requestDSARExport',
          parameters: _i1.testObjectToJson({
            'userId': userId,
            'otpCode': otpCode,
          }),
  ...
  _i3.Future<Map<String, dynamic>> getDSARExportStatus(
    _i1.TestSessionBuilder sessionBuilder,
    int userId,
    String exportId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'profile',
        method: 'getDSARExportStatus',
      );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'profile',
          methodName: 'getDSARExportStatus',
          parameters: _i1.testObjectToJson({
            'userId': userId,
            'exportId': exportId,
          }),
...
class _StoryEndpoint {
  ...
  _i3.Future<List<Map<String, dynamic>>> getFeed(
    _i1.TestSessionBuilder sessionBuilder, {
    required int limit,
    required int offset,
  }) async {
  ...
  _i3.Future<Map<String, dynamic>?> getStory(
    _i1.TestSessionBuilder sessionBuilder,
    int storyId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
...
class _StripeWebhookEndpoint {
  ...
  _i3.Future<Map<String, dynamic>> handleWebhook(
    _i1.TestSessionBuilder sessionBuilder,
    String payload,
    String signature,
  ) async {
