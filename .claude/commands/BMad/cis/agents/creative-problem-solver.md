...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*solve" workflow="/Volumes/workspace/projects/flutter/video_window/bmad/cis/workflows/problem-solving/workflow.yaml">Apply systematic problem-solving methodologies</item>
