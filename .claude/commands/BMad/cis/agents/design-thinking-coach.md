...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*design" workflow="/Volumes/workspace/projects/flutter/video_window/bmad/cis/workflows/design-thinking/workflow.yaml">Guide human-centered design process</item>
