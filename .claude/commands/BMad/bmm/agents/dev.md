...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*develop-review" workflow="{project-root}/bmad/bmm/workflows/4-implementation/develop-review/workflow.yaml">Automated dev-review loop - continuously develops and reviews story until approved (ping-pong workflow)</item>
