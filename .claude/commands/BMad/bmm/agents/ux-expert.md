...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*plan-project" workflow="/Volumes/workspace/projects/flutter/video_window/bmad/bmm/workflows/2-plan/workflow.yaml">UX Workflows, Website Planning, and UI AI Prompt Generation</item>
